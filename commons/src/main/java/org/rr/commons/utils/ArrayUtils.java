...
public class ArrayUtils {
	...
	/**
	 * Tell whether the given array is empty or not.
	 *
	 * @param values the array to test if it contains any entries.
	 * @return <code>true</code> if the length of the given array is 0 or the given array is <code>null</code>, <code>false</code> otherwise.
	 */
	 ...
	 *
	 * @param values the array to test if it contains any entries.
	 * @return <code>false</code> if the length of the given array is 0 or the given array is <code>null</code>, <code>true</code> otherwise.
	 */
	public static boolean isNotEmpty(String[] values) {
		return not(isEmpty(values));
	}
}
