...
public class LineReader {
   ...
   */
  public int readLine(StringBuilder str, int maxLineLength,
   ...
   */
  private int readDefaultLine(StringBuilder str, int maxLineLength, int maxBytesToConsume)
  throws IOException {
   ...
   */
  private int readCustomLine(StringBuilder str, int maxLineLength, int maxBytesToConsume)
      throws IOException {
    int txtLength = 0; // tracks str.getLength(), as an optimization
    long bytesConsumed = 0;
    int delPosn = 0;
   ...
   * @throws IOException if the underlying stream throws
   */
  public int readLine(StringBuilder str, int maxLineLength) throws IOException {
   ...
   * @throws IOException if the underlying stream throws
   */
  public int readLine(StringBuilder str) throws IOException {
