...
public class BaseDialog extends JDialog {
  ...
  public void setDialogMode(int mode) {
    ...
    switch (mode) {
      case OK_CANCEL_DIALOG :
        okButton =
          new JButton(Bundle.getString("BaseDialog.Action.OK"));
        okButton.addActionListener(okAction);
        buttonPane.add(okButton);
        cancelOrCloseButton =
          new JButton(Bundle.getString("BaseDialog.Action.Cancel"));
        cancelOrCloseButton.addActionListener(cancelOrCloseAction);
        buttonPane.add(cancelOrCloseButton);
        getRootPane().setDefaultButton(okButton);
        break;
      case CLOSE_DIALOG :
        cancelOrCloseButton = new JButton(Bundle.getString("BaseDialog.Action.Close"));
        cancelOrCloseButton.addActionListener(cancelOrCloseAction);
        buttonPane.add(cancelOrCloseButton);
        break;
    }
  ...
  private void buildUI() {
    ...
    contentPaneAndButtons.setLayout(new PercentLayout(PercentLayout.VERTICAL, 8));
    contentPaneAndButtons.setBorder(BorderFactory.createEmptyBorder(4, 10, 10, 10));
    ...
    buttonPane.setLayout(new ButtonAreaLayout(6));
