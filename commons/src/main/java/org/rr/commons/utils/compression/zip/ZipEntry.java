...
public class ZipEntry implements ZipConstants, Cloneable {
    ...
    public java.util.zip.ZipEntry convert() {
    	java.util.zip.ZipEntry entry = new java.util.zip.ZipEntry(this.name);
    	try {
			ReflectionUtils.setFieldValue(entry, "time", time);
			ReflectionUtils.setFieldValue(entry, "crc", crc);
			ReflectionUtils.setFieldValue(entry, "size", size);
			ReflectionUtils.setFieldValue(entry, "csize", csize);
			ReflectionUtils.setFieldValue(entry, "method", method);
			ReflectionUtils.setFieldValue(entry, "flag", flag);
			ReflectionUtils.setFieldValue(entry, "extra", extra);
			ReflectionUtils.setFieldValue(entry, "comment", comment);
