...
/**
 ...
 PERFORMANCE OF THE PROGRAM AND DOCUMENTATION REMAINS WITH THE USERimport java.awt.Component;
import java.awt.Container;
import java.awt.Dimension;
import java.awt.Insets;
import java.awt.LayoutManager;
...
/**
 * 
 * A vertical layout manager similar to java.awt.FlowLayout. Like FlowLayout components do not expand to fill available space except when the horizontal
 * alignment is <code>BOTH</code> in which case components are stretched horizontally. Unlike FlowLayout, components will not wrap to form another column if
 * there isn't enough space vertically. VerticalLayout can optionally anchor components to the top or bottom of the display area or center them between the top
 * and bottom.
 * 
 * Revision date 12th July 2001
 * 
 * @author Colin Mummery e-mail: colin_mummery@yahoo.com Homepage:www.kagi.com/equitysoft - Based on 'FlexLayout' in Java class libraries Vol 2 Chan/Lee
 *         Addison-Wesley 1998
 */
...
public class VerticalLayout implements LayoutManager {
	 ...
	 *            An int value which is one of <code>RIGHT, LEFT, CENTER, BOTH</code> for the horizontal alignment.
	 * @param anchor
	 *            An int value which is one of <code>TOP, BOTTOM, CENTER</code> indicating where the components are to appear if the display area exceeds the
	 *            minimum necessary.
	 */
