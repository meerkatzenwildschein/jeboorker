...
public class DefaultProperty extends AbstractProperty {
  ...
  public boolean equals(Object other) {
    ...
    return compare(this.getName(), dp.getName()) &&
      compare(this.getDisplayName(), dp.getDisplayName()) &&
      compare(this.getShortDescription(), dp.getShortDescription()) &&
      compare(this.getCategory(), dp.getCategory()) &&
      compare(this.getType(), dp.getType()) &&
      this.isEditable()== dp.isEditable();
  }
