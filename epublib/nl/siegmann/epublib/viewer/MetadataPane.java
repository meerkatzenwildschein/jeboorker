...
public class MetadataPane extends JPanel implements NavigationEventListener {
	...
	private static final Logger log = Logger.getLogger(MetadataPane.class.getName());
	...
	private void setCoverImage(JPanel contentPanel, Book book) {
		...
		try {
			...
			if (image == null) {
				log.warning("Unable to load cover image from book");
				return;
			}
...
//			label.setSize(100, 100);
			...
			log.log(Level.WARNING, "Unable to load cover image from book", e.getMessage());
		}
	}
